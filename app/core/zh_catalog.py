...
COMPONENT_ZH = {
    ...
    # ---------------- 水文与气候 ----------------
    "SoilMoisture": {
        "runon": "上游坡面来水（0=不考虑）", "f_bare": "裸地面积比例(0~1)",
        "soil_ew": "裸土蒸发系数", "veg_type": "植被类型字段",
        "intercept_cap_grass": "[草地]冠层截留容量", "zr_grass": "[草地]根区深度",
        "I_B_grass": "[草地]Beta分布参数b", "I_V_grass": "[草地]植被关联参数",
        "pc_grass": "[草地]孔隙率", "fc_grass": "[草地]田间持水量",
        "sc_grass": "[草地]饱和含水量", "wp_grass": "[草地]萎蔫点含水量",
        "hgw_grass": "[草地]重力水阈值", "beta_grass": "[草地]饱和曲线指数",
        "LAI_max_grass": "[草地]最大叶面积指数",
        "intercept_cap_shrub": "[灌木]冠层截留容量", "zr_shrub": "[灌木]根区深度",
        "I_B_shrub": "[灌木]Beta分布参数b", "I_V_shrub": "[灌木]植被关联参数",
        "pc_shrub": "[灌木]孔隙率", "fc_shrub": "[灌木]田间持水量",
        "wp_shrub": "[灌木]萎蔫点含水量", "hgw_shrub": "[灌木]重力水阈值",
        "beta_shrub": "[灌木]饱和曲线指数", "LAI_max_shrub": "[灌木]最大叶面积指数",
    },
